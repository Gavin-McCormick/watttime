...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sms_tools_twiliosmsevent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'TwilioSMSEvent.user'
        db.alter_column(u'sms_tools_twiliosmsevent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))
