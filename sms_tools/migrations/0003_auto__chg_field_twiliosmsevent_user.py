...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TwilioSMSEvent.user'
        db.alter_column(u'sms_tools_twiliosmsevent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TwilioSMSEvent.user'
        raise RuntimeError("Cannot reverse this migration. 'TwilioSMSEvent.user' and its values cannot be restored.")
