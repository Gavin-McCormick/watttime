...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InvitationKey.recipiant'
        db.delete_column('invitation_invitationkey', 'recipiant')

        # Adding field 'InvitationKey.recipient'
        db.add_column('invitation_invitationkey', 'recipient',
                      self.gf('django.db.models.fields.EmailField')(default=None, max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InvitationKey.recipiant'
        db.add_column('invitation_invitationkey', 'recipiant',
                      self.gf('django.db.models.fields.EmailField')(default=None, max_length=75, null=True),
                      keep_default=False)

        # Deleting field 'InvitationKey.recipient'
        db.delete_column('invitation_invitationkey', 'recipient')
    ...
    models = {
        ...
        'invitation.invitationkey': {
            ...
            'recipient': ('django.db.models.fields.EmailField', [], {'default': 'None', 'max_length': '75', 'null': 'True'}),
