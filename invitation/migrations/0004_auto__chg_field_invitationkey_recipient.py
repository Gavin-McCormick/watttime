...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvitationKey.recipient'
        db.alter_column('invitation_invitationkey', 'recipient', self.gf('picklefield.fields.PickledObjectField')(null=True))

    def backwards(self, orm):

        # Changing field 'InvitationKey.recipient'
        db.alter_column('invitation_invitationkey', 'recipient', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        ...
        'invitation.invitationkey': {
            ...
            'recipient': ('picklefield.fields.PickledObjectField', [], {'default': 'None', 'null': 'True'}),
