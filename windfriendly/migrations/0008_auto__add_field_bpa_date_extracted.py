...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BPA.date_extracted'
        db.add_column(u'windfriendly_bpa', 'date_extracted',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 30, 0, 0), db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BPA.date_extracted'
        db.delete_column(u'windfriendly_bpa', 'date_extracted')
