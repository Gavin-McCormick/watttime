...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NE.forecast_code'
        db.add_column(u'windfriendly_ne', 'forecast_code',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BPA.forecast_code'
        db.add_column(u'windfriendly_bpa', 'forecast_code',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NE.forecast_code'
        db.delete_column(u'windfriendly_ne', 'forecast_code')

        # Deleting field 'BPA.forecast_code'
        db.delete_column(u'windfriendly_bpa', 'forecast_code')
