...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NE.fraction_clean'
        db.add_column(u'windfriendly_ne', 'fraction_clean',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BPA.fraction_clean'
        db.add_column(u'windfriendly_bpa', 'fraction_clean',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'MISO.fraction_clean'
        db.add_column(u'windfriendly_miso', 'fraction_clean',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PJM.fraction_clean'
        db.add_column(u'windfriendly_pjm', 'fraction_clean',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'CAISO.fraction_clean'
        db.add_column(u'windfriendly_caiso', 'fraction_clean',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NE.fraction_clean'
        db.delete_column(u'windfriendly_ne', 'fraction_clean')

        # Deleting field 'BPA.fraction_clean'
        db.delete_column(u'windfriendly_bpa', 'fraction_clean')

        # Deleting field 'MISO.fraction_clean'
        db.delete_column(u'windfriendly_miso', 'fraction_clean')

        # Deleting field 'PJM.fraction_clean'
        db.delete_column(u'windfriendly_pjm', 'fraction_clean')

        # Deleting field 'CAISO.fraction_clean'
        db.delete_column(u'windfriendly_caiso', 'fraction_clean')
