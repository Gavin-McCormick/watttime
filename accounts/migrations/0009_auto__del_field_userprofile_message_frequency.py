...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.message_frequency'
        db.delete_column(u'accounts_userprofile', 'message_frequency')


    def backwards(self, orm):
        # Adding field 'UserProfile.message_frequency'
        db.add_column(u'accounts_userprofile', 'message_frequency',
