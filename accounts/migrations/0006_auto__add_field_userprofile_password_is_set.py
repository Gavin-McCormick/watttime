...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.password_is_set'
        db.add_column(u'accounts_userprofile', 'password_is_set',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.password_is_set'
        db.delete_column(u'accounts_userprofile', 'password_is_set')
