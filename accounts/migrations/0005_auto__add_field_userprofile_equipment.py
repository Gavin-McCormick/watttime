...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.equipment'
        db.add_column(u'accounts_userprofile', 'equipment',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.equipment'
        db.delete_column(u'accounts_userprofile', 'equipment')
    ...
    models = {
        u'accounts.userprofile': {
            ...
            'equipment': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '100'}),
