...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShiftRequest.fraction_green'
        db.delete_column(u'watttime_shift_shiftrequest', 'fraction_green')

        # Adding field 'ShiftRequest.recommended_fraction_green'
        db.add_column(u'watttime_shift_shiftrequest', 'recommended_fraction_green',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ShiftRequest.recommended_fraction_green'
